...
public class EventController {
    ...
    public ResponseEntity createEvent(@Valid @RequestBody Event event) {
        event.setId(null);
        Event created = eventService.createEvent(event.getName(), event.getTrack(), event.getTeams(), event.getDateOfEvent());
    ...
    public ResponseEntity deleteEventById(@PathVariable("id") Integer id) {
        if(!eventService.deleteEventById(id)) {
            return new ResponseEntity(String.format("There is no event with id %d", id)
    ...
    public ResponseEntity updateEventById(@PathVariable("id") Integer id, @RequestBody Event event) {
        event.setId(id);
    ...
    public ResponseEntity deleteTeamFromEventByName(@PathVariable("eventId") Integer eventId, @RequestBody String name) {
        if(!eventService.deleteTeamFromEventByName(eventId, name)) {
            return new ResponseEntity(String.format("There is no team name '%s' in team with id %d", name, eventId)
                    , HttpStatus.NOT_FOUND);
        }
